...
module.exports = function(passport) {
    ...
    function(req, email, password, done) { // callback with email and password from our form
        ...
        User.findOne({ 'mail' :  email }, function(err, user) {
            ...
            if (!user)
                return done(null, false, req.flash('error', 'Sorry Your Account Not Exits, Please Contact Administrator.')); // req.flash is the way to set flashdata using connect-flash
